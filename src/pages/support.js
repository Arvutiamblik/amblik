...
<table class="table">
    ...
    <tbody>
       <tr>
        ...
        <td id="hard"><div id="leftBoard"><p id="smallText">Server support</p><br/>118 â‚¬ / month<p id="smallText">for one server</p></div><div class="vl"></div><div id="rightBord"><p id="smallText">User support</p><br/> 59 â‚¬ / month<br/><p id="smallText">for one user</p></div></td>
